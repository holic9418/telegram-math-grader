...
→ 봇이 "이렇게 기록할게요" 미리보기를 보여드려요. <b>확인</b> 하시면 파일에 기록하고, <b>기록된 내용을 사진으로</b> 보내드려요. (아니면 <b>취소</b>)
...
• <b>7월 15일 원서진 과제</b> 처럼 물으면, 그날 그 학생의 과제수행·다음과제를 알려드려요.
...
• <b>시간표</b> : 수업 시간표 한눈에 (<code>시간표 초5A</code>·<code>시간표 월</code>·<code>시간표 담당</code> 처럼 골라 보기도 OK)
...
※ 사용 중 오류나 보완할 점이 발견되면 <b>태일쌤</b>에게 알려주세요. 열심히 고쳐보겠습니다! 🙇"""
